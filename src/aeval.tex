...
%
Fig.~\ref{fg:aeval} shows a Venn diagram for an example of the opposite scenario: $R_2(x) = T_1(x) \lor T_2(x)$ \andreas{shouldn't the previous disjunction be: $P_1(x) \lor P_2(x)?$}, but the input formula is invalid.
